    ...
    <div className={`space-y-1.5 ${className}`}>
      ...
      <div className="relative rounded-lg">
        ...
        <input
          ...
          className={`block w-full h-10 rounded-lg border bg-white dark:bg-[#0F172A] pl-10 pr-11 py-2 text-sm text-slate-900 dark:text-[#F8FAFC] placeholder:text-slate-400 dark:placeholder:text-[#64748B] shadow-2xs transition-all duration-150 focus:outline-none focus:ring-2 disabled:bg-slate-50 dark:disabled:bg-[#151F32] disabled:text-slate-400 dark:disabled:text-[#64748B] disabled:cursor-not-allowed ${
            error
              ? 'border-rose-300 dark:border-rose-500/50 focus:border-rose-500 focus:ring-rose-500/20'
              : 'border-slate-200 dark:border-[#263449] focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500/20'
          }`}
          {...props}
        />
